...
class GaussianGridProblem(Dataset):
    def __init__(self, n_data, prior, sde, number_of_obs=1,
        ...
        self._max_number_of_time_points = 10
    ...
    def _generate_data(self):
        ...
        self._thetas_global, self._thetas_local, self._xs = generate_synthetic_data(
            ...
            grid_size=int(np.ceil(np.sqrt(self._max_number_of_obs))) if self._max_number_of_obs > 1 else None,  # no need to simulate the full grid
